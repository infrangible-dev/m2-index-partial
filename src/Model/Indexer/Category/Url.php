    ...
    extends Indexer
{
    ...
    protected function performReindex()
    {
        ...
        $this->logging->debug(sprintf('Updating category url rewrite index for %d categories(s)',
            count($allEntityIds)));
        ...
        $this->logging->info(sprintf('Category url rewrite index was updated for %d categories(s)',
            count($allEntityIds)));
    }
